...
def process_frame(frame, reference_face_encoding, frame_count, frame_rate, output_dir):
...
while True:
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        future = executor.submit(process_frame, frame, reference_face_encoding, frame_count, frame_rate, output_dir)
